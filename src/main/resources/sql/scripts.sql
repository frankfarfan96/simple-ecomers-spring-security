...
insert into account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary
, transaction_type, transaction_amt, closing_balance, create_dt)
values (UUID(), 3321651256, 1, CURDATE()-6, "Uber", "Withdrawal", 100, 34400, CURDATE()-6);

insert into account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary
, transaction_type, transaction_amt, closing_balance, create_dt)
values (UUID(), 332163456, 1, CURDATE()-5, "Self Deposit", "Deposit", 500, 34900, CURDATE()-5);

insert into account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary
, transaction_type, transaction_amt, closing_balance, create_dt)
values (UUID(), 3321152456, 1, CURDATE()-4, "Ebay", "Withdrawal", 600, 34300, CURDATE()-4);

insert into account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary
, transaction_type, transaction_amt, closing_balance, create_dt)
values (UUID(), 3321589456, 1, CURDATE()-2, "OnlineTransfer", "Deposit", 700, 35000, CURDATE()-2);

insert into account_transactions (transaction_id, account_number, customer_id, transaction_dt, transaction_summary
, transaction_type, transaction_amt, closing_balance, create_dt)
values (UUID(), 3320984456, 1, CURDATE()-1, "Amazon.com", "Withdrawal", 100, 34900, CURDATE()-1);
